    ...
    <div className="w-screen h-screen bg-[#121316] text-white font-sans p-12 flex flex-col overflow-hidden relative">
      ...
      <div className="relative z-10 w-full h-full flex flex-col font-outfit max-w-[1600px] mx-auto">
        ...
        <div className="flex-1 grid grid-cols-12 gap-8 min-h-0">
          ...
          <div className="col-span-5 flex flex-col gap-2 justify-center overflow-y-auto pr-2">
            {data.map((item, index) => (
              <motion.div
                key={item.name}
                ...
                className="flex items-center gap-3 p-3 rounded-xl border border-white/5 bg-[#1E1F23]/50 hover:bg-[#1E1F23] transition-all hover:scale-[1.02] group"
              >
                <div 
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex justify-between items-baseline mb-0.5">
                    <h4 className="font-semibold text-base text-white truncate">{item.name}</h4>
