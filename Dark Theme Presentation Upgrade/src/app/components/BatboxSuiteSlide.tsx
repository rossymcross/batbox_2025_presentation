...
export const BatboxSuiteSlide: React.FC<BatboxSuiteSlideProps> = ({ onNext: _onNext, onPrev: _onPrev }) => {
        ...
        >
            ...
            <div>
              ...
              <div className="space-y-4">
                {benefits.map((benefit, index) => (
                  ...
                  >
                    <div 
                      className={`w-12 h-12 rounded-xl flex items-center justify-center shrink-0 transition-transform duration-300 hover:scale-110 hover:rotate-[5deg] ${
          ...
          >
            <motion.div 
              ...
              className="relative w-full h-full max-h-[700px] overflow-hidden rounded-2xl group transition-transform duration-300 hover:scale-[1.02]"
            >
