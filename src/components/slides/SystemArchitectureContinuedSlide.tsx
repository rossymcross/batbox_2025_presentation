    ...
    <div className="w-screen h-screen bg-[#121316] text-white font-sans p-12 flex flex-col overflow-y-auto relative">
      ...
      <div className="relative z-10 w-full h-full flex flex-col font-outfit max-w-[1600px] mx-auto">
        ...
        >
          ...
          {/* Game Kiosk & Source Code - Reduced width to accommodate Partner tile */}
          <motion.div variants={itemVariants} className="col-span-8 bg-[#1E1F23] border border-white/5 rounded-3xl p-8 relative overflow-hidden group hover:bg-[#25262B] transition-colors">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex-1">
                <h3 className="text-2xl font-bold text-white mb-2">Game Kiosk & Source Code</h3>
          ...
          <motion.div variants={itemVariants} className="col-span-4 bg-[#1E1F23] border border-white/5 rounded-3xl p-8 relative overflow-hidden group hover:bg-[#25262B] transition-colors">
            <div className="flex items-center gap-3 text-emerald-400 mb-6">
                ...
                <span className="font-semibold uppercase tracking-wider text-sm">Partnerships</span>
            </div>
            <h3 className="text-2xl font-bold text-white mb-4 leading-tight">Collaborations & Prototypes</h3>
            
            <div className="space-y-4">
               {/* Strikezon */}
               <div className="flex items-center gap-3">
                  <div className="w-2 h-2 rounded-full bg-emerald-400 shrink-0 animate-pulse" />
                  <span className="text-gray-300">Strikezon</span>
