...
function App() {
  ...
  const slides = [
    ...
    <BugReportsSlide key="bug-reports" onNext={() => setCurrentSlide(7)} onPrev={() => setCurrentSlide(5)} />,
    <SupportSlide key="support" onNext={() => setCurrentSlide(8)} onPrev={() => setCurrentSlide(6)} />,
    <DevelopmentTeamSlide key="dev-team" onNext={() => setCurrentSlide(9)} onPrev={() => setCurrentSlide(7)} />,
    <InfrastructureSlide key="infrastructure" onNext={() => setCurrentSlide(10)} onPrev={() => setCurrentSlide(8)} />,
    <SystemArchitectureContinuedSlide key="infrastructure-2" onNext={() => setCurrentSlide(11)} onPrev={() => setCurrentSlide(9)} />,
    <UserExperienceSlide key="user-experience" onNext={() => setCurrentSlide(12)} onPrev={() => setCurrentSlide(10)} />,
    <ObjectivesSlide key="objectives" onNext={() => setCurrentSlide(13)} onPrev={() => setCurrentSlide(11)} />,
    <AddisonLaunchSlide key="addison-launch" onNext={() => setCurrentSlide(14)} onPrev={() => setCurrentSlide(12)} />,
    <AddisonKPISlide key="addison-kpis" onNext={() => setCurrentSlide(15)} onPrev={() => setCurrentSlide(13)} />,
    <DemographicsSlide key="demographics" onNext={() => setCurrentSlide(16)} onPrev={() => setCurrentSlide(14)} />,
    <GameplayAnalysisSlide key="gameplay-analysis" onNext={() => setCurrentSlide(17)} onPrev={() => setCurrentSlide(15)} />,
    <FinancialAnalysisSlide key="financial-analysis" onNext={() => setCurrentSlide(18)} onPrev={() => setCurrentSlide(16)} />,
    <EventsAnalysisSlide key="events-analysis" onNext={() => setCurrentSlide(19)} onPrev={() => setCurrentSlide(17)} />,
    <AddisonSuccessStorySlide key="addison-success" onNext={() => setCurrentSlide(20)} onPrev={() => setCurrentSlide(18)} />,
    <VirtualDugoutLaunchSlide key="virtual-dugout" onNext={() => setCurrentSlide(21)} onPrev={() => setCurrentSlide(19)} />,
    <VirtualDugoutStatisticsSlide key="virtual-stats" onNext={() => setCurrentSlide(22)} onPrev={() => setCurrentSlide(20)} />
  ];
